...
export function InlinePlanModeCard({ request, busy, onSubmit }: InlinePlanModeCardProps) {
    ...
    <article className="inline-interaction-card">
      ...
      <div className="dialog-body plan-mode-body">
        ...
        {request.planFilePath ? (
          <p className="dialog-description">
            Plan file: <code>{request.planFilePath}</code>
          </p>
        ) : null}
      ...
      <div className="dialog-actions">
        <button
          ...
          onClick={() => onSubmit({ mode: 'revise', notes: 'User cancelled the plan review.' })}
          disabled={busy}
        >
          Cancel
        </button>
